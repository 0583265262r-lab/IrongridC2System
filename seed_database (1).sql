...
CREATE TABLE IF NOT EXISTS Units (
    Id INT NOT NULL,
    UnitName VARCHAR(255) NOT NULL DEFAULT 'Unknown Unit',
    Sector VARCHAR(255) NOT NULL DEFAULT 'General',
    PRIMARY KEY (Id)
);
...
CREATE TABLE Assets (
    ...
    AssetType VARCHAR(255) NOT NULL DEFAULT 'GenericAsset',
    PRIMARY KEY (Id),
    CONSTRAINT FK_Assets_Units_UnitId
...
CREATE TABLE AssetLiveStatus (
    ...
    PRIMARY KEY (AssetId),
    CONSTRAINT FK_AssetLiveStatus_Assets_AssetId
